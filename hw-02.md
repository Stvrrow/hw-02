...
![Авторизация](https://github.com/Stvrrow/smon-homeworks/hw-02/img/img1.png)
...
![Hosts](https://github.com/Stvrrow/smon-homeworks/hw-02/img/img2.png)

2. Cкриншот лога zabbix agent, где видно, что он работает с сервером

![Лог zabbix agent](https://github.com/Stvrrow/smon-homeworks/hw-02/img/img3.png)

3. Скриншоты раздела Monitoring > Latest data для обоих хостов, где видны поступающие от агентов данные.

![Latest data dev11-slave](https://github.com/Stvrrow/smon-homeworks/hw-02/img/img4.png)

![Latest data dev11-server](https://github.com/Stvrrow/smon-homeworks/hw-02/img/img5.png)
